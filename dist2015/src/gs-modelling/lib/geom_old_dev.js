...
exports._del = _del;
exports._getAttrib = _getAttrib;
exports._getGroups = _getGroups;
exports._mirror = _mirror;
exports._move = _move;
exports._removeFromAllGroups = _removeFromAllGroups;
exports._rotate = _rotate;
exports._scale = _scale;
exports._transform = _transform;
exports._CopyObject = _CopyObject;
exports._CopyObjects = _CopyObjects;
//  ===============================================================================================================
//  Geom Functions ================================================================================================
//  ===============================================================================================================
// - WEEK 2 -
 ...
 */
function _mirror(geom, plane, copy) {
    /* Old Implementation for one obj
 ...
 */
function _move(geom, translation, copy) {
    /* Old implementation for one obj
    if (obj === undefined) {return null;}
    const points_IDs: Set<number> = obj.getPointsSet();
    for (const point_ID of points_IDs) {
 ...
 */
function _removeFromAllGroups(geom) {
    throw new Error("Method not implemented");
}
/**
 ...
 */
function _rotate(geom, rotation, plane, copy) {
    /* Old Implementation for one obj
    if (obj === undefined) {return null;}
 ...
 */
function _scale(geom, origin, scale, copy) {
    /* Old Implementation for one obj
    if (obj === undefined) {return null;}
    const points_IDs: Set<number> = obj.getPointsSet();
    for (const point_ID of points_IDs) {
 ...
 */
function _transform(geom, rotation, origin, scale, translation, copy) {
    /* Old Implementation for one obj
    RotateObject(m, obj, rotation, plane);
    ScaleObject(m, obj, origin, scale);
    MoveObject(m, obj, translation);
...
function _CopyObject(m, obj, translation) {
    // To implement
...
function _CopyObjects(m, objs, translation) {
    // To implement
    if (objs === undefined) {
        return [];
    }
...
//# sourceMappingURL=geom_old_dev.js.map