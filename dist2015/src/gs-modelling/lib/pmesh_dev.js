...
exports._CopyFromModel = _CopyFromModel;
exports._area = _area;
 ...
 */
function _CopyFromModel(model_1, model_2) {
 ...
 */
function _BoxFromPlane(plane, length_x, length_y, length_z) {
  throw new Error("Method not implemented");
}
 ...
 * @returns New polymesh if successful, null if unsuccessful or on error
 */
function _PipeFromPline(polyline, radius, cap) {
  throw new Error("Method not implemented");
}
/**
 ...
 * @returns New polymesh if successful, null if unsuccessful or on error
 */
function _RectFromPlane(plane, length_x, length_y) {
  throw new Error("Method not implemented");
}
//  ===============================================================================================================
//  Pmesh Functions ===============================================================================================
 ...
 */
function _extract(pmesh, polygon_index, return_remainder, copy) {
  throw new Error("Method not implemented");
}
 ...
 */
function _offset(pmesh, distance, copy) {
  throw new Error("Method not implemented");
}
/**
 ...
 * @returns List of new polymeshes created from extract
 */
function _thicken(pmesh, dist_1, dist_2) {
  throw new Error("Method not implemented");
}
/**
 ...
 */
function _weld(pmeshes, is_closed) {
  throw new Error("Method not implemented");
}
//  ===============================================================================================================
 ...
 * @returns New polymesh if successful, null if unsuccessful or on error
 */
function _Extrude(m, polymesh, polyline, cap) {
  throw new Error("Method not implemented");
}
/*
 ...
 * @returns New polymesh if successful, null if unsuccessful or on error
 */
function _BooleanDifference2D(m, input0, input1, plane, delete_input) {
  throw new Error("Method not implemented");
}
//# sourceMappingURL=pmesh_dev.js.map