 ...
 */
export function AddInterpPolyline(m: gs.IModel, points: [gs.IPoint, gs.IPoint...])  {
    throw new Error("Method not implemented");
}
 ...
 */
export function EvaluatePolyline(m: gs.IModel, polyline: gs.IPolyline, t: number) {
    throw new Error("Method not implemented");
}
