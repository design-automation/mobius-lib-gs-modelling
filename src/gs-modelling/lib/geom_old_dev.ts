 ...
 */
export function _del(geom: gs.IGeom[]): number {
 ...
 */
export function _getAttrib(geom: gs.IGeom): gs.IAttrib[] {
    throw new Error("Method not implemented");
}
 ...
 */
export function _getGroups(geom: gs.IGeom): gs.IGroup[] {
    throw new Error("Method not implemented");
}
 ...
 */
export function _mirror(geom: gs.IGeom, plane: gs.IPlane, copy: boolean): gs.IGeom {
    /* Old Implementation for one obj
 ...
 */
export function _move(geom: gs.IGeom, translation: number[], copy: boolean): gs.IGeom {
    /* Old implementation for one obj
    if (obj === undefined) {return null;}
    const points_IDs: Set<number> = obj.getPointsSet();
    for (const point_ID of points_IDs) {
 ...
 */
export function _removeFromAllGroups(geom: gs.IGeom): boolean {
    throw new Error("Method not implemented");
}
 ...
 */
export function _rotate(geom: gs.IGeom, rotation: number, plane: gs.IPlane, copy: boolean): gs.IGeom {
    /* Old Implementation for one obj
    if (obj === undefined) {return null;}
 ...
 */
export function _scale(geom: gs.IGeom, origin: number[], scale: number, copy: boolean): gs.IGeom {
    /* Old Implementation for one obj
    if (obj === undefined) {return null;}
    const points_IDs: Set<number> = obj.getPointsSet();
    for (const point_ID of points_IDs) {
 ...
 */
export function _transform(geom: gs.IGeom, rotation: number, origin: number[], scale: number,
...
export function _CopyObject(m: gs.IModel, obj: gs.IObj, translation?: number[]): number {
// To implement
...
export function _CopyObjects(m: gs.IModel, objs: gs.IObj[], translation?: number[]): number[] {
    // To implement
