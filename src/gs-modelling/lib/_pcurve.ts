 ...
 */
export function _circle(m: gs.IModel, plane: gs.IPlane, radius: number): gs.INurbsCurve {
 ...
 * @returns New curve object
 */
export function _ellipse(m: gs.IModel, plane: gs.IPlane, radiusX: number, radiusY: number ): gs.INurbsCurve {
    throw new Error("Method not implemented");
}
 ...
 */
export function _CurveMidPoint(m: gs.IModel, curve: gs.INurbsCurve, segment_index: number ): gs.IPoint {
    throw new Error("Method not implemented");
}
 ...
 */
export function _CurveLength(m: gs.IModel, curve: gs.INurbsCurve, segment_index: number,
 ...
 */
export function _DivideCurve(m: gs.IModel, curve: gs.INurbsCurve, segments: number,
 ...
 */
export function _AddInterpCurve(m: gs.IModel, points: [gs.IPoint, gs.IPoint]): gs.INurbsCurve {
    throw new Error("Method not implemented");
}
 ...
 * @returns New curve object if successful, none if unsuccessful or on error
 */
export function _ExtendCurveLength(m: gs.IModel, curve: gs.INurbsCurve, extrusion_type: number,
 ...
 */
export function _EvaluateCurve(m: gs.IModel, curve: gs.INurbsCurve, t: number): gs.IPoint {
    throw new Error("Method not implemented");
}
 ...
 */
export function _CurveClosestPoint(m: gs.IModel, curve: gs.INurbsCurve, point: gs.IPoint): gs.IPoint {
    throw new Error("Method not implemented");
}
